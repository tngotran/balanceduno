    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mKpSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromTouch) {
                ...
                mKpSeekBarValue.setText(String.format("%.3f", newKpValue)); // Two decimal places
            }
        ...
        mKpSeekBar.setProgress(mKpSeekBar.getMax() / 2);//for initial stage

        mKiSeekBar = (SeekBar) v.findViewById(R.id.KiSeekBar);
        mKiSeekBar.setMax(100); // 0-20
        ...
        mKiSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromTouch) {
                newKiValue = (float) progress / 100000.0f; // Since the SeekBar can only handle integers, so this is needed
                mKiSeekBarValue.setText(String.format("%.5f", newKiValue)); // Two decimal places
//                newKiValue = (float) progress / 10000.0f; // Since the SeekBar can only handle integers, so this is needed
//                mKiSeekBarValue.setText(String.format("%.4f", newKiValue)); // Two decimal places
            }
        ...
        mKdSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromTouch) {
                ...
                mKdSeekBarValue.setText(String.format("%.3f", newKdValue)); // Two decimal places
            }
        ...
        mTargetAngleSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromTouch) {
                newTargetAngleValue = (float) progress / 10000.0f;// + 150.0f; // It's not possible to set the minimum value either, so we will add a offset
                mTargetAngleSeekBarValue.setText(String.format("%.4f", newTargetAngleValue)); // Two decimal places
            }
    ...
    public static void updateView() {
        if (mKpView != null && mKpSeekBar != null && mKpSeekBarValue != null && !BalanduinoActivity.pValue.isEmpty()) {
            ...
            mKpSeekBarValue.setText(String.format("%.3f", Float.parseFloat(BalanduinoActivity.pValue))); // Two decimal places
        ...
        if (mKiView != null && mKiSeekBar != null && mKiSeekBarValue != null && !BalanduinoActivity.iValue.isEmpty()) {
            ...
            mKiSeekBarValue.setText(String.format("%.5f", Float.parseFloat(BalanduinoActivity.iValue))); // Two decimal places
            mKiSeekBar.setProgress((int) (Float.parseFloat(BalanduinoActivity.iValue) * 100000.0f));
//            mKiSeekBarValue.setText(String.format("%.4f", Float.parseFloat(BalanduinoActivity.iValue))); // Two decimal places
//            mKiSeekBar.setProgress((int) (Float.parseFloat(BalanduinoActivity.iValue) * 10000.0f));
        }
        if (mKdView != null && mKdSeekBar != null && mKdSeekBarValue != null && !BalanduinoActivity.dValue.isEmpty()) {
            ...
            mKdSeekBarValue.setText(String.format("%.3f", Float.parseFloat(BalanduinoActivity.dValue))); // Two decimal places
        ...
        if (mTargetAngleView != null && mTargetAngleSeekBar != null && mTargetAngleSeekBarValue != null && !BalanduinoActivity.targetAngleValue.isEmpty()) {
            ...
            mTargetAngleSeekBarValue.setText(String.format("%.4f", Float.parseFloat(BalanduinoActivity.targetAngleValue))); // Two decimal places
//            mTargetAngleSeekBar.setProgress((int) ((Float.parseFloat(BalanduinoActivity.targetAngleValue) - 150.0f) * 10.0f));
            mTargetAngleSeekBar.setProgress((int) ((Float.parseFloat(BalanduinoActivity.targetAngleValue)) * 10000.0f));
        }
    }
