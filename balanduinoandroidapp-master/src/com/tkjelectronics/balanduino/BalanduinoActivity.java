...
public class BalanduinoActivity extends SherlockFragmentActivity implements ActionBar.TabListener {
    ...
    public final static String setHeight = "SH";
    ...
    public final static String sendMachineGun = "CT;";
    public final static String sendYahoo = "CY;";
    public final static String sendEatCake = "CE;";
    public final static String sendJapan = "CA;";
    public final static String sendDisagree = "CD;";
    public final static String sendHate = "CH;";
